...
class MainActivity : AppCompatActivity() {
    ...
    private fun averageLessThanMedian(listOfNumbers: List<Double>): Boolean = listOfNumbers.average() < listOfNumbers.sorted().let {
        if(it.size % 2 == 0) it[it.size / 2] else it[it.size-1/2]/2
    }
